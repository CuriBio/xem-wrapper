...
if version_info >= (2, 6, 0):
    ...
    def swig_import_helper():
        ...
        try:
            if print_debug_statements:
                print(
                    f"Looking for the _ok DLL with possible suffixes {imp.get_suffixes()} in {dirname(__file__)} which is the dirname of {__file__}"
                )
            if print_debug_statements:
        ...
        if print_debug_statements:
            print(
                f"some info was determined about _ok: fp {fp}   pathname {pathname}  description {description}"
            )
        if fp is not None:
            try:
                ...
                fp.close()
            if print_debug_statements:
                print(f"This is the _mod being returned: {_mod}")
            return _mod

    _ok = swig_import_helper()
    del swig_import_helper
else:
    import _ok  # type: ignore
del version_info
try:
...
class okBuffer(_object):
    ...
    def __getitem__(self, *args):
        return _ok.okBuffer___getitem__(self, *args)

    def __setitem__(self, *args):
        return _ok.okBuffer___setitem__(self, *args)
...
class okCScriptValue(_object):
    __swig_setmethods__ = {}  # type: ignore
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, okCScriptValue, name, value
    )
    __swig_getmethods__ = {}  # type: ignore
...
class okCScriptValues(_object):
    __swig_setmethods__ = {}  # type: ignore
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, okCScriptValues, name, value
    )
    __swig_getmethods__ = {}  # type: ignore
    ...
    def __getslice__(self, *args):
        return _ok.okCScriptValues___getslice__(self, *args)

    def __setslice__(self, *args):
        return _ok.okCScriptValues___setslice__(self, *args)

    def __delslice__(self, *args):
        return _ok.okCScriptValues___delslice__(self, *args)
    ...
    def append(self, *args):
        return _ok.okCScriptValues_append(self, *args)
    ...
    def swap(self, *args):
        return _ok.okCScriptValues_swap(self, *args)
    ...
    def push_back(self, *args):
        return _ok.okCScriptValues_push_back(self, *args)
    ...
    def assign(self, *args):
        return _ok.okCScriptValues_assign(self, *args)
    ...
    def reserve(self, *args):
        return _ok.okCScriptValues_reserve(self, *args)
...
class okCScriptEngine(_object):
    __swig_setmethods__ = {}  # type: ignore
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, okCScriptEngine, name, value
    )
    __swig_getmethods__ = {}  # type: ignore
    ...
    def LoadScript(self, *args):
        return _ok.okCScriptEngine_LoadScript(self, *args)
...
class okCFrontPanel(_object):
    ...
    __swig_getmethods__[
        "GetAPIVersionMajor"
    ] = lambda x: _ok.okCFrontPanel_GetAPIVersionMajor
    if _newclass:
        GetAPIVersionMajor = staticmethod(_ok.okCFrontPanel_GetAPIVersionMajor)
    __swig_getmethods__[
        "GetAPIVersionMinor"
    ] = lambda x: _ok.okCFrontPanel_GetAPIVersionMinor
    if _newclass:
        GetAPIVersionMinor = staticmethod(_ok.okCFrontPanel_GetAPIVersionMinor)
    __swig_getmethods__[
        "GetAPIVersionMicro"
    ] = lambda x: _ok.okCFrontPanel_GetAPIVersionMicro
    if _newclass:
        GetAPIVersionMicro = staticmethod(_ok.okCFrontPanel_GetAPIVersionMicro)
    __swig_getmethods__[
        "GetAPIVersionString"
    ] = lambda x: _ok.okCFrontPanel_GetAPIVersionString
    if _newclass:
        GetAPIVersionString = staticmethod(_ok.okCFrontPanel_GetAPIVersionString)
    __swig_getmethods__["CheckAPIVersion"] = lambda x: _ok.okCFrontPanel_CheckAPIVersion
    if _newclass:
        CheckAPIVersion = staticmethod(_ok.okCFrontPanel_CheckAPIVersion)
    ...
    def ConfigureFPGAFromMemory(self, *args):
        return _ok.okCFrontPanel_ConfigureFPGAFromMemory(self, *args)
    ...
    __swig_getmethods__[
        "FindUSBDeviceModel"
    ] = lambda x: _ok.okCFrontPanel_FindUSBDeviceModel
    if _newclass:
        FindUSBDeviceModel = staticmethod(_ok.okCFrontPanel_FindUSBDeviceModel)
    __swig_getmethods__[
        "GetBoardModelString"
    ...
    def GetTriggerOutVector(self, *args):
        return _ok.okCFrontPanel_GetTriggerOutVector(self, *args)
...
class okCFrontPanelDevices(_object):
    __swig_setmethods__ = {}  # type: ignore
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, okCFrontPanelDevices, name, value
    )
    __swig_getmethods__ = {}  # type: ignore
    ...
    def GetSerial(self, *args):
        return _ok.okCFrontPanelDevices_GetSerial(self, *args)
...
class FrontPanelDevices(okCFrontPanelDevices):
    __swig_setmethods__ = {}  # type: ignore
    for _s in [okCFrontPanelDevices]:
        __swig_setmethods__.update(getattr(_s, "__swig_setmethods__", {}))
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, FrontPanelDevices, name, value
    )
    __swig_getmethods__ = {}  # type: ignore
    for _s in [okCFrontPanelDevices]:
        __swig_getmethods__.update(getattr(_s, "__swig_getmethods__", {}))
